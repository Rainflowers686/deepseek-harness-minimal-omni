...
- Normal community mode uses the user's existing DSH_HOME. Maintainer
  acceptance mode is separate and enables stricter isolation and request
  accounting through explicit environment settings.
